...
this.jDoctest = (((window, $) => {
    ...
    j.Parser.prototype = {
        ...
        getExamples(docString, lineNo) {
            ...
            */
            ...
            var R = RegExp;
            var promptRegex = new R( "^(\\s*)" + e( this.symbols.prompt + " " ) );
            var continuedRegex;
            var wantRegex;
            var blankRegex = /^\s*$/;
            var match;
    ...
    j.Runner.prototype = {
        ...
        progress(justOneStep) {
            ...
            */
            ...
            var runner = this;
            var flags = this.adjustFlags( exam.flags, exam.negativeFlags );
            var flag;
            var check;
        ...
        eval(source) {
            ...
            */
            ...
            if ( $.browser.msie ) {
                ...
                var scr = "<script class='" + cls + "'>" + source + "</script>";
    ...
    ***********************************************************************/
    ...
    j.flags = {
        ...
        ACCEPT_TRUE_FOR_1(want, got) {
            ...
            */
            ...
            var F = got === j.repr( false ) && want === j.repr( 0 );
            if ( T || F ) {
                return true;
            }
        },
        ACCEPT_BLANKLINE(want, got) {
        ...
        IGNORE_ERROR_MESSAGE(want, got) {
            ...
            */
            ...
            var isError = errorName => {
                var error = window[ errorName ];
                return error === Error || error.prototype instanceof Error;
            };

            var matchWant = errorName.exec( want );
            var matchGot = errorName.exec( got );
            var wantedError;
            var gotError;
    ...
    ((j => {
        ...
        var negative = j.makeNegativeFlag;
